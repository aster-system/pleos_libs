...
namespace pleos {
    ...
    public:
        ...
        public:
            ...
            inline scls::Fraction height() const {return a_height;};
            inline scls::Fraction max_x() const {return attached_object()->x() + a_width / 2;};
            inline scls::Fraction max_y() const {return attached_object()->y() + a_height / 2;};
            inline scls::Fraction min_x() const {return attached_object()->x() - a_width / 2;};
            inline scls::Fraction min_y() const {return attached_object()->y() - a_height / 2;};
        ...
        public:
            ...
            void add_collision(std::shared_ptr<Graphic_Collision> collision){a_collisions.push_back(collision);};
            ...
            std::shared_ptr<Graphic_Collision> new_collision();
            ...
            // Next movement generated by the speed
            inline double next_movement_x()const{return a_velocity.x() * a_delta_time;};
            inline double next_movement_y()const{return a_velocity.y() * a_delta_time;};
            ...
            inline void set_velocity_x(double new_velocity_x, bool with_delta_time){if(with_delta_time){a_velocity.set_x(new_velocity_x / a_delta_time);}else{a_velocity.set_x(new_velocity_x);}};
            inline void set_velocity_x(double new_velocity_x){set_velocity_x(new_velocity_x, false);};
            inline void set_velocity_y(double new_velocity_y, bool with_delta_time){if(with_delta_time){a_velocity.set_y(new_velocity_y / a_delta_time);}else{a_velocity.set_y(new_velocity_y);}};
            ...
            inline double velocity_x() {return a_velocity.x();};
            inline double velocity_y() {return a_velocity.y();};
        private:
            // Attached object
            std::weak_ptr<Graphic_Base_Object> a_attached_object;
    ...
    public:
        ...
        public:
            ...
            void __move(){__move(scls::Point_3D(physic_object()->next_movement_x(), physic_object()->next_movement_y(), 0));};
            ...
            // Getters and setters
            inline scls::Fraction max_x_next() const {return a_x + a_width / 2 + scls::Fraction::from_double(physic_object()->next_movement_x());};
            inline scls::Fraction max_y_next() const {return a_y + a_height / 2 + scls::Fraction::from_double(physic_object()->next_movement_y());};
            inline scls::Fraction min_x_next() const {return a_x - a_width / 2 + scls::Fraction::from_double(physic_object()->next_movement_x());};
            inline scls::Fraction min_y_next() const {return a_y - a_height / 2 + scls::Fraction::from_double(physic_object()->next_movement_y());};
